...
export default function TeamMember({ image, name, role, bio }: { image: string; name: string; role: string; bio: string; }) {
  return (
    <div className="flex flex-col space-y-3 p-8 items-start bg-(--stardust-white) rounded-lg text-(--silver-lake-blue) max-w-80 min-w-60 w-auto h-130 shadow-xl hover:shadow-2xl transform hover:scale-105 transition duration-300">
